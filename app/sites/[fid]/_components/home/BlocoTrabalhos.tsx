        ...
        {trabalhos.map((t) => (
          <Link key={t.id} href={url(t)} style={{ textDecoration: "none", color: "var(--site-texto)" }}>
            ...
            <div style={{ position: "relative", overflow: "hidden", background: t.capa_url ? "var(--site-superficie)" : gradPlaceholder(t.id), aspectRatio: aspect }}>
              ...
              <div style={{ position: "absolute", left: 0, right: 0, bottom: 0, display: "flex", justifyContent: "center", gap: 22, padding: "34px 12px 8px", fontSize: 25, fontWeight: 700, color: "#fff", background: "linear-gradient(to top, rgba(0,0,0,0.6), rgba(0,0,0,0))" }}>
