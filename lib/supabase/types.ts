...
export type SiteConfig = {
  ...
  tema: string;
  publicado: boolean;
  marca_dagua: boolean;     // queima a marca do fotógrafo nas fotos NOVAS do site
...
export type CrmContract = { id: string; fotografo_id: string; pedido_id: string; template_id: string | null; nome_template: string | null; corpo_gerado: string | null; arquivo_path?: string | null; arquivo_url?: string | null; arquivo_nome?: string | null; created_at: string; assinado_em?: string | null; assinado_nome?: string | null; assinado_ip?: string | null; assinado_user_agent?: string | null; assinatura_png?: string | null };
